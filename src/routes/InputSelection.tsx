  ...
  return (
    <div className={styles.component}>
      ...
      <main className={styles.content}>
        ...
        <DemoPuzzles
          onClickPuzzle={props.goToExample} />
...
const DemoPuzzles = (props: DemoPuzzlesProps) => {
  ...
  const textPuzzles =
      join(textArr, commaElem)
        .map((element, idx) => React.cloneElement(element, { key: idx }));
